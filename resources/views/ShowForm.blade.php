        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                <div class="title m-b-md">
                    <form action="{{url('post_input')}}" method="post">
                        {{ csrf_field() }}
                        <input type="text" name="query_point" hint="QUERY POINT" placeholder="query point" class="form-control">
                        <input type="text" name="data_point" hint="DATA POINT" placeholder="data point" class="form-control">
